...
export const nodeFsLstatSyncExportName = "lstatSync";
export const nodeFsLstatSyncSignatureId = "node:fs.lstatSync(System.String)";
...
export const nodeFsStatsIsSymbolicLinkMemberId = "node:fs.Stats.isSymbolicLink";
export const nodeFsStatsIsSymbolicLinkSignatureId = "node:fs.Stats.isSymbolicLink()";
