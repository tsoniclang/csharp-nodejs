...
import {
  ...
  nodeFsStatsIsSymbolicLinkMemberId,
  nodeFsStatsIsSymbolicLinkSignatureId,
...
const nodeFsStatsCallTargetMetadataRows = [
  ...
  },
  {
    ...
    memberId: nodeFsStatsIsSymbolicLinkMemberId,
    signatureId: nodeFsStatsIsSymbolicLinkSignatureId,
    providerReturnType: boolProviderType,
    member: {
      id: "Tsonic.CSharp.Node.Stats.IsSymbolicLink()",
      sourceName: "isSymbolicLink",
      targetName: "IsSymbolicLink",
      kind: "method",
      parameters: [],
      returnType: boolTargetType,
      declaringType: statsTargetType,
