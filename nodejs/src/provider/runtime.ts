...
import { csharpCoreRuntimeSource, csharpJsRuntimeSource, csharpRuntimeSourceContributions } from "@tsonic/target-csharp/provider";

export function nodejsRuntimeContributions(
