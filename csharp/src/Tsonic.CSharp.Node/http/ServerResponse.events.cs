...
public partial class ServerResponse
{
    ...
    public new ServerResponse on(string eventName, Action listener)
    {
    ...
    public new ServerResponse on(string eventName, Action<Exception> listener)
    {
        base.on(eventName, listener);
        return this;
    }
    ...
    public new ServerResponse once(string eventName, Action listener)
    {
    ...
    public new ServerResponse once(string eventName, Action<Exception> listener)
    {
        base.once(eventName, listener);
        return this;
    }
    ...
    public new ServerResponse off(string eventName, Action listener)
    {
    ...
    public new ServerResponse off(string eventName, Action<Exception> listener)
    {
        base.off(eventName, listener);
        return this;
    }
